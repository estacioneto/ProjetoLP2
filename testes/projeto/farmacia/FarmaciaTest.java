...
public class FarmaciaTest {
	...
	public void testCriaMedicamentos() {
		try {
			farmacia.addMedicamento("Dipirona", 9.98, 550, "Referencia", "analgesico,antiemetico,antitermico");
			farmacia.addMedicamento("Dorflex", 10.50, 600, "Referencia", "antibiotico");
			farmacia.addMedicamento("Morfina", 374.90, 100, "Referencia", "analgesico,antitermico");
			farmacia.addMedicamento("Roacutan", 189.80, 350, "Referencia", "analgesico,antiemetico");
			farmacia.addMedicamento("Viagra", 48.90, 70, "Referencia", "hormonal,antitermico");
			farmacia.addMedicamento("Neosaldina", 19.62, 200, "Referencia", "analgesico,antiinflamatorio");
			farmacia.addMedicamento("Claril", 10.38, 172, "Referencia", "antiinflamatorio");
			farmacia.addMedicamento("Prednisona", 10.38, 172, "Referencia", "antitermico");
			farmacia.addMedicamento("Isotretinoina", 79.90, 200, "Generico", "analgesico,antiemetico,antitermico");
			farmacia.addMedicamento("Aciclovir", 10.50, 600, "Generico", "analgesico,antitermico");
			farmacia.addMedicamento("Albendazol", 374.90, 100, "Generico", "analgesico");
			farmacia.addMedicamento("Amoxicilina", 189.80, 350, "Generico", "analgesico,antiemetico,antitermico");
		} catch (Exception e) {
			fail();
		}
	}
...
//		}
	...
	public void TestaEstadosDoObjeto() {
		...
		try {
			...
			farmacia.addMedicamento("Apracur", 7.18, 300, "Referencia", "analgesico,hormonal");
			farmacia.addMedicamento("Dimeticona", 14.90, 200, "Generico", "analgesico,antiemetico");
			farmacia.addMedicamento("Prednisona", 10.38, 172, "Referencia", "antitermico");
			farmacia.addMedicamento("Isotretinoina", 79.90, 200, "Generico", "analgesico,antiemetico,antitermico");
			farmacia.addMedicamento("Aciclovir", 10.50, 600, "Generico", "analgesico,antitermico");

			assertEquals(farmacia.getInfoMedicamento("Nome", "Apracur"), farmacia.getListaMedicamentos().get(0).getNome());
			assertEquals(farmacia.getInfoMedicamento("Nome", "Dimeticona"), farmacia.getListaMedicamentos().get(1).getNome());
			assertEquals(farmacia.getInfoMedicamento("Nome", "Isotretinoina"), farmacia.getListaMedicamentos().get(3).getNome());
			assertEquals(farmacia.getInfoMedicamento("Nome", "Prednisona"), farmacia.getListaMedicamentos().get(2).getNome());

			assertEquals(8.94, (Double)farmacia.getInfoMedicamento("Preco", "Dimeticona"), 0.01);// Medicamento
															// generico
															// desconto 40%
															// (14.90 * 0.6
															// = 8.94)
			assertEquals(7.18, (Double)farmacia.getInfoMedicamento("Preco", "Apracur"), 0.01);
			assertEquals(47.94, (Double)farmacia.getInfoMedicamento("Preco", "Isotretinoina"), 0.01);// Medicamento
																// generico
																// desconto
																// 40%
																// (79.90 *
																// 0.6 =
																// 47.94)
			assertEquals(6.3, (Double)farmacia.getInfoMedicamento("Preco", "Aciclovir"), 0.01);// Medicamento
															// generico
															// desconto 40%
															// (10.50 * 0.6
															// = 6.3)

			assertEquals(300, farmacia.getInfoMedicamento("Quantidade", "Apracur"));
			assertEquals(200, farmacia.getInfoMedicamento("Quantidade", "Isotretinoina"));
			assertEquals(200, farmacia.getInfoMedicamento("Quantidade", "Dimeticona"));
			assertEquals(600, farmacia.getInfoMedicamento("Quantidade", "Aciclovir"));
		} catch (Exception e) {
			fail();
		}
	}
