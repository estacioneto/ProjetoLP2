...
public class Medicamento implements Serializable {
	...
	@Validacao(metodo = ConstantesReflection.VALIDA_STRING, erro = Constantes.CATEGORIAS
			+ Constantes.DO_MEDICAMENTO)
...
//			}
	...
	public String toString() {
		String formatacao = String.format(
				...
				this.tipo.toString(), this.getNome(), this.getPreco(),
	...
	public boolean equals(Object obj) {
		if (obj instanceof Medicamento) {
			...
			if (objMedicamento.getPreco() == this.getPreco()
